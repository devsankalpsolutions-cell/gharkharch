...
interface TripParticipantModalProps {
  isOpen: boolean;
  onClose: () => void;
  tripId: string;
}

export const TripParticipantModal: React.FC<TripParticipantModalProps> = ({
  isOpen,
  onClose,
  tripId,
}) => {
  const { addTripParticipant } = useFinance();
